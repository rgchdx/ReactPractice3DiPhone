...
const Model = () => {
    ...
    const [model,setModel] = useState({
        title:'iPhone16 Pro in natural titanium',
        color:['#8F8A81','#FFE7B9','#6F6C64'],
        img: yellowImg,
    })

    //setup camera control for the model view
    //camera control and not the model
    const cameraControlSmall = useRef();
    const cameraControlLarge = useRef();

    //keeping track of the model to access its properties
    //new group of three js elements
    //models themselves
